...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 80881 or testnet: 180881)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 80880 or testnet: 180880)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Fucoin Wiki for SSL setup instructions)") + "\n" +
